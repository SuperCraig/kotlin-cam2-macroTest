package com.example.easy_toggle
...
class EasyToggle: View {
    ...
    constructor(context: Context?, attrs: AttributeSet?, defStyleAttr: Int): super(context, attrs, defStyleAttr){
        context?.theme?.obtainStyledAttributes(attrs, R.styleable.EasyToggle, defStyleAttr, 0).let{
            ...
            shadowOffsetY = it.getDimensionPixelOffset(R.styleable.EasyToggle_etShadowOffsetY, TypedValue.applyDimension(
